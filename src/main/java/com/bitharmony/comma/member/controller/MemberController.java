...
public class MemberController {
    ...
    /**
     * 사용자가 username과 password를 입력하면,
     * 유효성 검증을 거쳐 로그인을 로직을 실행하고,
     * 정상적으로 처리가 되면 JWT을 respone body로 반환
     * 클라이언트를 해당 JWT를 받아서 매 요청마다 헤더로 포함해서
     * 서버로 전송해야한다.
     */
    @PostMapping("/login")
    ...
    /**
     * 사용자가 회원가입에 필요한 데이터를 입력하면,
     * 유효성 검증을 거쳐 회원가입 로직을 실행한다.
     * 정상적으로 처리가 되면 회원가입한 정보의 일부를
     * 클라이언트로 반환한다.
     */
